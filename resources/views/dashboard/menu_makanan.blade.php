        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{route('add_menu',1)}}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data Makanan</a>
                        <hr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <a href="{{route('hapus_makanan',$m->id_menu)}}" class="btn btn-danger">Hapus</a>
                                            </center>
                                        </td>
                                    </tr>
                                    @endforeach
