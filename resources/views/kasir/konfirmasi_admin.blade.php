            ...
            <div class="stat-content itam">
              <div id="cetak">
                ...
                <table width="100%">
                  ...
                  @php
                  $jumlah_pesanan = \App\Models\Orderan::where('id_menu',$ps->id_menu)->where('status_menu','1')->sum('jumlah');
              ...
              <a href="{{ route('laporan_transaksi_admin') }}" class="btn btn-danger btn-block"><i class="fa fa-home"></i> Kembali Ke Laporan</a>
            </div>
          </div>
        </div>
      </div>
