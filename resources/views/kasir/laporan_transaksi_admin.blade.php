        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              @if(!isset($mulai))
              <form action="{{ route('filter_transaksi_admin') }}" method="POST">
                @csrf
              ...
              <hr>
              <form action="{{ route('cetak_transaksi_admin') }}" target="_blank" method="POST">
                @csrf
              ...
              <table id="example" class="display" style="min-width: 845px">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <center>
                        <a href="{{route('cetak_ulang_admin',$t->kode_pembayaran)}}" class="btn btn-info"><i class="fa fa-print"></i> Cetak Bill</a>
                      </center>
                    </td>
                  </tr>
                  @endforeach
