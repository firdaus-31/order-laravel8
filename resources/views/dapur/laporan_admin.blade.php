        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <form action="{{route('filter_laporan_admin')}}" method="POST">
                @csrf
              ...
              <form action="{{route('cetak_laporan_admin')}}" method="POST" target="_blank">
                @csrf
              ...
              <table id="example" class="display" style="min-width: 845px">
                ...
                <tbody>
                  ...
                  @else
                  @php
                  $order = App\Models\Orderan::whereDate('updated_at','>=',$mulai)->whereDate('updated_at','<=',$akhir)->where('id_menu',$mn->id_menu)->where('status_pesanan','2')->sum('jumlah');
                    $proses = App\Models\Orderan::where('id_menu',$mn->id_menu)->where('status_pesanan','2')->first();
                    @endphp
                    @endif
                    <tr>
                      ...
                      <td class="itam">
                        <center>{{ date('d-m-Y',strtotime($proses->updated_at)) }}</center>
                      </td>
